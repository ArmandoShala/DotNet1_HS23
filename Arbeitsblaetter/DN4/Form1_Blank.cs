...
namespace DN4
{
    public partial class Form1_Blank : Form
    {
        private IList<Orb_Blank> space = new List<Orb_Blank>();
        ...
        {
            foreach (Orb_Blank o in space) o.CalcVelocity(space);
            foreach (Orb_Blank o in space) o.Move();
            this.Refresh();
        }

        protected override void OnPaint(PaintEventArgs e)
        {
            foreach (Orb_Blank o in space) o.Draw(e.Graphics);
        }
    }
}